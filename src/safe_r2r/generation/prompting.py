...
def build_rag_prompt(question: str, docs: List[RetrievedDoc]) -> str:
    ...
    return (
        ...
        "1) Output ONLY the final answer as a short span.\n"
        "2) Do NOT explain.\n"
        "3) Do NOT add extra words.\n"
        "4) Do NOT include quotes.\n"
        "5) If the answer is yes/no, output exactly: yes OR no\n"
        "6) If the documents do not contain enough information, output exactly: Insufficient evidence\n\n"
        f"Documents:\n{ctx}\n\n"
        f"Question: {question}\n"
        "Final answer:"
    )